...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."MIGR_FILTER" IS OBJECT (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."MIGR_FILTER_SET" IS TABLE OF MIGR_FILTER;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."MIGR_REPORT_DETAIL_ROW" AS OBJECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."MIGR_REPORT_DETAIL_TABLE" AS TABLE OF MIGR_REPORT_DETAIL_ROW;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."MIGR_REPORT_SUM_ROW" AS OBJECT
       (LABEL           VARCHAR2(50),
	    SCHEMA_SUM      NUMBER,
        TABLE_SUM       NUMBER,
		INDEX_SUM       NUMBER,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."MIGR_REPORT_SUM_TABLE" AS TABLE OF MIGR_REPORT_SUM_ROW;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."NAMELIST" IS TABLE OF VARCHAR2(40);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."NAME_AND_COUNT_ARRAY" IS VARRAY(30) OF name_and_count_t;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."NAME_AND_COUNT_T" IS OBJECT (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "LANA"."OBJECTIDLIST" IS TABLE OF INTEGER;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "LANA"."DBOBJECTID_SEQUENCE"  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 50 START WITH 1 CACHE 50 NOORDER  NOCYCLE   ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."CATALOG_ID_FK" IS 'Catalog to which this schema blongs //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."NAME" IS 'Name of the schema //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."TYPE" IS 'Type of this schema.  Eaxamples are ''CAPTURED'' OR ''CONVERTED''';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."CHARACTER_SET" IS 'The characterset of this schema';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."VERSION_TAG" IS 'A version string that can be used for tagging/baseling a schema';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."NATIVE_SQL" IS 'The native SQL used to create this schema';
   COMMENT ON COLUMN "LANA"."MD_SCHEMAS"."NATIVE_KEY" IS 'A unique identifier that this schema is known as in its source state.';
   COMMENT ON TABLE "LANA"."MD_SCHEMAS"  IS 'This is the holder for schemas';
--------------------------------------------------------
--  DDL for Table MD_SEQUENCES
--------------------------------------------------------

  CREATE TABLE "LANA"."MD_SEQUENCES" 
   (	"ID" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
	"NAME" VARCHAR2(4000 BYTE), 
	"SEQ_START" NUMBER, 
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_SEQUENCES"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_SEQUENCES"."SCHEMA_ID_FK" IS 'The schema to which this object belongs. //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_SEQUENCES"."NAME" IS 'Name of this sequence //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_SEQUENCES"."SEQ_START" IS 'Starting point of the sequence';
   COMMENT ON COLUMN "LANA"."MD_SEQUENCES"."INCR" IS 'Increment value of the sequence';
   COMMENT ON COLUMN "LANA"."MD_SEQUENCES"."NATIVE_SQL" IS 'SQL used to create this object at source';
...
--------------------------------------------------------
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."SCHEMA_ID_FK" IS 'The schema to which this object belongs //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."NAME" IS 'Synonym name //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."SYNONYM_FOR_ID" IS 'What object this is a synonym for';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."FOR_OBJECT_TYPE" IS 'The type this is a synonym for (e.g. INDEX)';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."PRIVATE_VISIBILITY" IS 'Visibility - Private or Public.  If Private_visibility = ''Y'' means this is a private synonym.  Anything else means it is a public synonym';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."NATIVE_SQL" IS 'The SQL used to create this object at source';
   COMMENT ON COLUMN "LANA"."MD_SYNONYMS"."NATIVE_KEY" IS 'An identifier for this object at source.';
   COMMENT ON TABLE "LANA"."MD_SYNONYMS"  IS 'For storing synonym information.';
--------------------------------------------------------
--  DDL for Table MD_TABLES
--------------------------------------------------------

  CREATE TABLE "LANA"."MD_TABLES" 
   (	"ID" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_TABLES"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_TABLES"."SCHEMA_ID_FK" IS 'Schema in which this table resides //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_TABLES"."TABLE_NAME" IS 'Name of the table //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_TABLES"."NATIVE_SQL" IS 'SQL Used to create this table at soruce';
...
--------------------------------------------------------
  ...
  CREATE TABLE "LANA"."MD_TARGET_ALL_ERRORS" 
...
--------------------------------------------------------
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."TABLE_OR_VIEW_ID_FK" IS 'Table on which this trigger fires';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."TRIGGER_ON_FLAG" IS 'Flag to show iif the trigger is on a table or a view.  If it is a table this should be ''T''. If it is on a view this should be ''V''';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."TRIGGER_NAME" IS 'Name of the trigger //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."TRIGGER_TIMING" IS 'before, after ,etc.';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."TRIGGER_OPERATION" IS 'insert, delete, etc.';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."TRIGGER_EVENT" IS 'The actual trigger that gets fired ';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."NATIVE_SQL" IS 'The full definition ';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."NATIVE_KEY" IS 'UInique identifer for this object at source';
   COMMENT ON COLUMN "LANA"."MD_TRIGGERS"."LANGUAGE" IS '//PUBLIC';
   COMMENT ON TABLE "LANA"."MD_TRIGGERS"  IS 'For storing information about triggers.';
--------------------------------------------------------
--  DDL for Table MD_USERS
--------------------------------------------------------

  CREATE TABLE "LANA"."MD_USERS" 
   (	"ID" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
	"USERNAME" VARCHAR2(4000 BYTE), 
	"PASSWORD" VARCHAR2(4000 BYTE), 
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_USERS"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_USERS"."SCHEMA_ID_FK" IS 'Shema in which this object belongs //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_USERS"."USERNAME" IS 'Username for login //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_USERS"."PASSWORD" IS 'Password for login';
   COMMENT ON COLUMN "LANA"."MD_USERS"."NATIVE_SQL" IS 'SQL Used to create this object at source';
   COMMENT ON COLUMN "LANA"."MD_USERS"."NATIVE_KEY" IS 'Unique identifier for this object at source.';
   COMMENT ON TABLE "LANA"."MD_USERS"  IS 'User information.';
--------------------------------------------------------
--  DDL for Table MD_USER_DEFINED_DATA_TYPES
--------------------------------------------------------

  CREATE TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" 
   (	"ID" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_USER_DEFINED_DATA_TYPES"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_USER_DEFINED_DATA_TYPES"."SCHEMA_ID_FK" IS 'Schema to which this object blongs. //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_USER_DEFINED_DATA_TYPES"."DATA_TYPE_NAME" IS 'The name of the data type //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_USER_DEFINED_DATA_TYPES"."DEFINITION" IS 'The definition of the data type';
   COMMENT ON COLUMN "LANA"."MD_USER_DEFINED_DATA_TYPES"."NATIVE_SQL" IS 'The native SQL used to create this object';
   COMMENT ON COLUMN "LANA"."MD_USER_DEFINED_DATA_TYPES"."NATIVE_KEY" IS 'An unique identifier for this object at source.';
   COMMENT ON TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES"  IS 'For storing information on user defined data types.';
--------------------------------------------------------
--  DDL for Table MD_USER_PRIVILEGES
--------------------------------------------------------

  CREATE TABLE "LANA"."MD_USER_PRIVILEGES" 
   (	"ID" NUMBER, 
	"USER_ID_FK" NUMBER, 
	"PRIVILEGE_ID_FK" NUMBER, 
	"SECURITY_GROUP_ID" NUMBER DEFAULT 0, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "LANA"."MD_USER_PRIVILEGES"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_USER_PRIVILEGES"."USER_ID_FK" IS 'User';
   COMMENT ON COLUMN "LANA"."MD_USER_PRIVILEGES"."PRIVILEGE_ID_FK" IS 'Privilege';
   COMMENT ON TABLE "LANA"."MD_USER_PRIVILEGES"  IS 'This table stores privileges granted to individual users';
--------------------------------------------------------
--  DDL for Table MD_VIEWS
--------------------------------------------------------

  CREATE TABLE "LANA"."MD_VIEWS" 
   (	"ID" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
 ...
 LOB ("NATIVE_SQL") STORE AS BASICFILE (
  ...
  CACHE READS LOGGING ) ;
   ...
   COMMENT ON COLUMN "LANA"."MD_VIEWS"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MD_VIEWS"."SCHEMA_ID_FK" IS 'The schema to which this obect blongs. //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MD_VIEWS"."VIEW_NAME" IS 'The name of the view //OBJECTNAME';
   COMMENT ON COLUMN "LANA"."MD_VIEWS"."NATIVE_SQL" IS 'The SQL used to create this object at source';
   COMMENT ON COLUMN "LANA"."MD_VIEWS"."NATIVE_KEY" IS 'An identifier for this object at source.';
   COMMENT ON COLUMN "LANA"."MD_VIEWS"."LANGUAGE" IS '//PUBLIC';
   COMMENT ON TABLE "LANA"."MD_VIEWS"  IS 'For storing information on views.';
--------------------------------------------------------
--  DDL for Table MIGRATION_RESERVED_WORDS
--------------------------------------------------------

  CREATE TABLE "LANA"."MIGRATION_RESERVED_WORDS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" 
   (	"ID" NUMBER, 
	"MAP_ID_FK" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."ID" IS 'Primary Key';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."MAP_ID_FK" IS 'The map to which this rule belongs //PARENTFIELD';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."SOURCE_DATA_TYPE_NAME" IS 'Source data type';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."SOURCE_PRECISION" IS 'Precison to match';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."SOURCE_SCALE" IS 'scale to match';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."TARGET_DATA_TYPE_NAME" IS 'data type name to transform to';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."TARGET_PRECISION" IS 'precision to map to ';
   COMMENT ON COLUMN "LANA"."MIGR_DATATYPE_TRANSFORM_RULE"."TARGET_SCALE" IS 'scale to map to';
--------------------------------------------------------
--  DDL for Table MIGR_GENERATION_ORDER
--------------------------------------------------------

  CREATE TABLE "LANA"."MIGR_GENERATION_ORDER" 
   (	"ID" NUMBER, 
	"CONNECTION_ID_FK" NUMBER, 
	"OBJECT_ID" NUMBER, 
	"OBJECT_TYPE" VARCHAR2(4000 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_CHECK_CONSTRAINTS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_COLUMNS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_DATABASES" 
   (	"DB_ID" NUMBER(10,0), 
	"NAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_DATABASE_PRINCIPALS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_DATABASE_ROLE_MEMBERS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_DEFAULT_CONSTRAINTS" 
   (	"DB_ID" NUMBER(10,0), 
	"DEFINITION" CLOB, 
	"OBJECT_ID" NUMBER(10,0)
   ) ON COMMIT PRESERVE ROWS ;
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_IDENTITY_COLUMNS" 
   (	"DB_ID" NUMBER(20,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_INDEXES" 
   (	"DB_ID" NUMBER(10,0), 
	"OBJECT_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_INDEX_COLUMNS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_OBJECTS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_SCHEMATA" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_SERVER_PRINCIPALS" 
   (	"DB_ID" NUMBER(10,0), 
	"NAME" VARCHAR2(256 BYTE), 
	"SID" RAW(85), 
	"TYPE" CHAR(2 BYTE)
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_SQL_MODULES" 
   (	"DB_ID" NUMBER(10,0), 
	"DEFINITION" CLOB, 
	"OBJECT_ID" NUMBER(10,0)
   ) ON COMMIT PRESERVE ROWS ;
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_SYSPROPERTIES" 
   (	"DB_ID" NUMBER(5,0), 
	"MAJOR_ID" NUMBER(5,0), 
	"MINOR_ID" NUMBER(5,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_TABLES" 
   (	"DB_ID" NUMBER(10,0), 
	"NAME" VARCHAR2(256 BYTE), 
	"OBJECT_ID" NUMBER(10,0), 
	"SCHEMA_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_TABLE_PRIVILEGES" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SS2K5_TYPES" 
   (	"DB_ID" NUMBER(10,0), 
	"NAME" VARCHAR2(256 BYTE), 
	"USER_TYPE_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "LANA"."STAGE_MIGRLOG" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"ID" NUMBER, 
	"REF_OBJECT_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SERVERDETAIL" 
   (	"SVRID" NUMBER, 
	"DBURL" VARCHAR2(4000 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_CHECK_CONSTRAINTS" 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_COLUMNS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_DATABASES" 
   (	"SVRID_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_DB_PRINCIPALS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_DB_ROLE_MEMBERS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_DT_CONSTRAINTS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_IDENTITY_COLUMNS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"OBJECT_ID_GEN" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_INDEXES" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"OBJECT_ID_GEN" NUMBER(38,0), 
	"OBJECT_ID" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_INDEX_COLUMNS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"OBJECT_ID_GEN" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_OBJECTS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"OBJID_GEN" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_SCHEMAS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_SCHEMATA" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"SUID_GEN" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_SERVER_PRINCIPALS" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"DB_ID" NUMBER(38,0), 
	"NAME" VARCHAR2(256 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_SQL_MODULES" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"OBJID_GEN" NUMBER(38,0), 
	"DEFINITION" CLOB, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_SYSPROPERTIES" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"CLASS" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_TABLES" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"OBJID_GEN" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_TABLE_PRIVILEGES" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SS2K5_TYPES" 
   (	"SVRID_FK" NUMBER(38,0), 
	"DBID_GEN_FK" NUMBER(38,0), 
	"NAME" VARCHAR2(256 BYTE), 
	"USER_TYPE_ID" NUMBER(38,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSCOLUMNS" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"ID_GEN_FK" NUMBER, 
	"COLID_GEN" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSCOMMENTS" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"ID_GEN_FK" NUMBER, 
	"ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSCONSTRAINTS" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSDATABASES" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN" NUMBER, 
	"NAME" VARCHAR2(255 BYTE), 
	"DBID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSINDEXES" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"ID_GEN_FK" NUMBER, 
	"INDID_GEN" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSOBJECTS" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"OBJID_GEN" NUMBER, 
	"SUID_GEN_FK" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSREFERENCES" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSTYPES" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"DB_UID" NUMBER, 
	"USERTYPE" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_SYB12_SYSUSERS" 
   (	"SVRID_FK" NUMBER, 
	"DBID_GEN_FK" NUMBER, 
	"SUID_GEN" NUMBER, 
	"GEN_ID_FK" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_ALL_RI_PARENTS" 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_COLUMNS" 
   (	"MDID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_DATABASES" 
   (	"SVRID" NUMBER, 
	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
	"COMMENTSTRING" VARCHAR2(255 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_FKEYS" 
   (	"MDID1" NUMBER, 
	"MDID2" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_IDXCONSTRAINTS" 
   (	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
	"TABLENAME" VARCHAR2(128 CHAR), 
	"INDEXNAME" VARCHAR2(128 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_INDICES" 
   (	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
	"TABLENAME" VARCHAR2(128 CHAR), 
	"INDEXNUMBER" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_JOININDICES" 
   (	"DATABASENAME" VARCHAR2(128 CHAR), 
	"TABLENAME" VARCHAR2(128 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_LOG" 
   (	"LINE" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_CHECK" 
   (	"INDEX" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_FKEYS" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
	"TABNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_INDC" 
   (	"INDEX" NUMBER, 
	"NAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_INDDET" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
	"TABNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_INDEXES" 
   (	"INDEX" NUMBER, 
	"ID" VARCHAR2(16 BYTE), 
	"DBNAME" VARCHAR2(256 BYTE), 
	"TABNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_PKEYS" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
	"TABNAME" VARCHAR2(256 BYTE), 
	"CONSTNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_PROCS" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
	"NAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_TABLES" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
	"TABNAME" VARCHAR2(256 BYTE), 
	"COLNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_TRIGS" 
   (	"INDEX" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_VDEFNS" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_OFFLINE_VIEWS" 
   (	"INDEX" NUMBER, 
	"DBNAME" VARCHAR2(256 BYTE), 
	"VIEWNAME" VARCHAR2(256 BYTE), 
	"COLNAME" VARCHAR2(256 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_PROCEDURES" 
   (	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_SHOWTBLCHECKS" 
   (	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
	"TABLENAME" VARCHAR2(128 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_TABLES" 
   (	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
	"TABLENAME" VARCHAR2(128 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_TABLETEXT" 
   (	"DATABASENAME" VARCHAR2(128 CHAR), 
	"TABLENAME" VARCHAR2(128 CHAR), 
	"TABLEKIND" CHAR(1 CHAR), 
	"REQUESTTEXT" CLOB
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_TRIGGERS" 
   (	"MDID" NUMBER, 
	"DATABASENAME" VARCHAR2(128 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TERADATA_UDTS" 
   (	"MDID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."STAGE_TRANSLATEDSQL" 
   (	"SERVER_ID_FK" NUMBER, 
	"DB_ID_FK" NUMBER, 
	"SCHEMA_ID_FK" NUMBER, 
	"OBJ_ID_FK" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SYB12_SYSCOLUMNS" 
   (	"DB_ID" NUMBER(10,0), 
	"ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SYB12_SYSCOMMENTS" 
   (	"DB_ID" NUMBER(10,0), 
	"ID" NUMBER(10,0), 
	"DB_NUMBER" NUMBER(10,0), 
	"COLID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE GLOBAL TEMPORARY TABLE "LANA"."SYB12_SYSCONSTRAINTS" 
   (	"DB_ID" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_CAPTURED_SQL" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME", "NATIVE_SQL", "LINECOUNT") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_CATALOGS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "DBURL", "CATALOG_ID", "CATALOG_NAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_CATALOG_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_COLUMNDT_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME", "DATATYPE", "ISIDENTITY") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_COLUMN_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
  SELECT 'MD_COLUMNS' objtype, c.COLUMN_NAME objname, c.Id objid,  'MD_TABLES' MainObjType,t.table_name MAINOBJNAME, t.id MAINOBJID, s.name SchemaName, s.id schemaid, cat.catalog_name catalogname,cat.id catalogid, conn.name connname,conn.id  connid,proj.project_name projectname,proj.id projectid,
NVL(conn.type,'CAPTURED') CapturedOrConverted, 
CASE WHEN conn.type IS NULL THEN cat.catalog_name||'.' ELSE '' END || s.name||'.'||t.table_name ||'.'||c.COLUMN_NAME QualifiedName
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_CONNECTIONS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "CONNECTION_NAME", "HOST", "PORT", "USERNAME", "DBURL") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    MD_CONNECTIONS.ID CONNECTION_ID ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_CONSTRAINTS_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_INDEX_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_PARTITIONS_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_PROGRAMS_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_SCHEMA" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_SCHEMA_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_STORED_PROGRAMS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "STORED_PROGRAM_ID", "PROGRAMTYPE", "STORED_PROGRAM_NAME", "PACKAGE_ID_FK") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name ,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_TABLES" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "DBURL", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "TABLE_ID", "TABLE_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_TABLES_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_TABLE_TRIGGERS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "DUMMY_FLAG", "SCHEMA_ID", "SCHEMA_NAME", "TABLE_ID", "TABLE_NAME", "TRIGGER_ID", "TRIGGER_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_TRIGGER_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_VIEWS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "DUMMY_FLAG", "SCHEMA_ID", "SCHEMA_NAME", "VIEW_ID", "VIEW_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
WITH READ ONLY;
   ...
   COMMENT ON TABLE "LANA"."MGV_ALL_VIEWS"  IS 'View to iterate over all views in the system'
;
--------------------------------------------------------
--  DDL for View MGV_ALL_VIEW_DETAILS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_VIEW_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_ALL_VIEW_TRIGGERS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "DUMMY_FLAG", "SCHEMA_ID", "SCHEMA_NAME", "VIEW_ID", "VIEW_NAME", "TRIGGER_ID", "TRIGGER_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "LANA"."MGV_SCRATCH_DERIVATIVES" ("ID", "SRC_ID", "SRC_TYPE", "DERIVED_ID", "DERIVED_TYPE", "DERIVED_CONNECTION_ID_FK", "TRANSFORMED", "ORIGINAL_IDENTIFIER", "NEW_IDENTIFIER", "DERIVED_OBJECT_NAMESPACE", "DERIVATIVE_REASON", "SECURITY_GROUP_ID", "CREATED_ON", "CREATED_BY", "LAST_UPDATED_ON", "LAST_UPDATED_BY", "ENABLED") AS 
...
--------------------------------------------------------
  ...
  CREATE MATERIALIZED VIEW "LANA"."MD_REGEX_CATALOG_MVIEW" ("PROJECT_ID", "CONNECTION_ID", "CONNECTION_NAME", "CATALOG_ID", "CATALOG_NAME", "ITEM", "VALUE")
 ...
 NOCOMPRESS LOGGING
  ...
  AS SELECT  PROJECT_ID, CONNECTION_ID, CONNECTION_NAME,CATALOG_ID,
   ...
   COMMENT ON MATERIALIZED VIEW "LANA"."MD_REGEX_CATALOG_MVIEW"  IS 'snapshot table for snapshot LANA.MD_REGEX_CATALOG_MVIEW';
--------------------------------------------------------
--  DDL for Materialized View MD_REGEX_MVIEW
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "LANA"."MD_REGEX_MVIEW" ("PROJECT_NAME", "PROJECT_ID", "CONNECTION_ID", "CONNECTION_NAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "PROGRAM_ID", "PROGRAM_NAME", "ITEM", "VALUE")
  ORGANIZATION HEAP PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" 
  BUILD IMMEDIATE
...
and regexp_count(p.native_sql,rg.REGEX,1,'ix')>0;
   ...
   COMMENT ON MATERIALIZED VIEW "LANA"."MD_REGEX_MVIEW"  IS 'snapshot table for snapshot LANA.MD_REGEX_MVIEW';
--------------------------------------------------------
--  DDL for Materialized View MD_REGEX_SCHEMA_MVIEW
--------------------------------------------------------

  CREATE MATERIALIZED VIEW "LANA"."MD_REGEX_SCHEMA_MVIEW" ("PROJECT_ID", "CONNECTION_ID", "CONNECTION_NAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "ITEM", "VALUE")
  ORGANIZATION HEAP PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" 
  BUILD IMMEDIATE
...
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('PACKAGE','MIGRATION_TRANSFORMER',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('PACKAGE','MIGRATION',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('PACKAGE','MIGRATION_REPORT',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_STORED_PROGRAMS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_TABLE_TRIGGERS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_VIEWS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_CONNECTIONS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_VIEW_TRIGGERS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_CATALOGS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_SCHEMA',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_TABLES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_PARTITIONS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_CAPTURED_SQL',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_CATALOG_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_SCHEMA_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_TABLES_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_PROGRAMS_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_VIEW_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_COLUMN_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_COLUMNDT_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_CONSTRAINTS_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_INDEX_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_TRIGGER_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_ALL_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_DERIVED_DETAILS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_DERIVATIVES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('VIEW','MGV_SCRATCH_DERIVATIVES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('SEQUENCE','DBOBJECTID_SEQUENCE',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_CATALOGS','DATABASE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MIGRLOG',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_GROUP_PRIVILEGES','GROUP PRIVILEGE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_USER_PRIVILEGES','USER_PRIVILEGE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MIGR_DATATYPE_TRANSFORM_MAP',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MIGR_DATATYPE_TRANSFORM_RULE',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_MIGR_PARAMETER','PARAMETER');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_MIGR_DEPENDENCY','DEPENDENCY');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_MIGR_WEAKDEP','DEPENDENCY');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MIGR_GENERATION_ORDER',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_CONSTRAINT_DETAILS','CONSTRAINT');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_CONSTRAINTS','CONSTRAINT');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_REPOVERSIONS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_OTHER_OBJECTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_SYNONYMS','SYNONYM');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MIGRATION_RESERVED_WORDS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_PACKAGES','PACKAGE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_SEQUENCES','SEQUENCE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_DERIVATIVES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_ADDITIONAL_PROPERTIES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_TABLESPACES','TABLESPACE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_STORED_PROGRAMS','PROCEDURE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_TRIGGERS','TRIGGER');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_USER_DEFINED_DATA_TYPES','UDT');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_PRIVILEGES','PRIVILEGE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_GROUP_MEMBERS','GROUP MEMBER');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_GROUPS','GROUP');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_INDEX_DETAILS','INDEX');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_PROJECTS','PROJECT');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_CONNECTIONS','MODEL');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_USERS','USER');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_SCHEMAS','SCHEMA');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_TABLES','TABLE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_VIEWS','VIEW');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_INDEXES','INDEX');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_COLUMNS','COLUMN');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_PARTITIONS','PARTITION');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_APPLICATIONS','TABLE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_APPLICATIONFILES','TABLE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_FILE_ARTIFACTS','TABLE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_NUMROW$SOURCE','NUMROW$SOURCE');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','MD_NUMROW$TARGET','NUMROW$TARGET');
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSDATABASES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSUSERS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSOBJECTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSCOLUMNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSTYPES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSCOMMENTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSINDEXES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SYB12_SYSCONSTRAINTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_DATABASES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_SCHEMATA',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_TABLE_PRIVILEGES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_CHECK_CONSTRAINTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_COLUMNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_DATABASE_PRINCIPALS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_DATABASE_ROLE_MEMBERS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_FOREIGN_KEY_COLUMNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_FOREIGN_KEYS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_IDENTITY_COLUMNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_INDEX_COLUMNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_INDEXES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_OBJECTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_SCHEMAS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_SERVER_PRINCIPALS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_SQL_MODULES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_TABLES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_TYPES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_DEFAULT_CONSTRAINTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','SS2K5_SYSPROPERTIES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','OBJECTIDLIST',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','NAME_AND_COUNT_T',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','NAME_AND_COUNT_ARRAY',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','NAMELIST',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','MIGR_FILTER',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','MIGR_FILTER_SET',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','MIGR_REPORT_DETAIL_ROW',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','MIGR_REPORT_DETAIL_TABLE',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','MIGR_REPORT_SUM_ROW',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TYPE','MIGR_REPORT_SUM_TABLE',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_CHECK',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_INDC',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_INDDET',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_INDEXES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_PKEYS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_PROCS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_TABLES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_TRIGS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_VIEWS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_VDEFNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_OFFLINE_FKEYS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_LOG',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_DATABASES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_TABLES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_COLUMNS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_TABLETEXT',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_TRIGGERS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_UDTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_INDICES',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_FKEYS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_IDXCONSTRAINTS',null);
Insert into LANA.MD_REGISTRY (OBJECT_TYPE,OBJECT_NAME,DESC_OBJECT_NAME) values ('TABLE','STAGE_TERADATA_ALL_RI_PARENTS',null);
...
SET DEFINE OFF;
REM INSERTING into LANA.MD_USERS
SET DEFINE OFF;
REM INSERTING into LANA.MD_USER_DEFINED_DATA_TYPES
SET DEFINE OFF;
REM INSERTING into LANA.MD_USER_PRIVILEGES
SET DEFINE OFF;
REM INSERTING into LANA.MD_VIEWS
SET DEFINE OFF;
REM INSERTING into LANA.MIGRATION_RESERVED_WORDS
SET DEFINE OFF;
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SHARE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('LEVEL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('RAW');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DROP');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('BETWEEN');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('FROM');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DESC');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('OPTION');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('PRIOR');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('LONG');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('THEN');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DEFAULT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ALTER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('IS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INTO');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('MINUS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INTEGER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('NUMBER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('GRANT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('IDENTIFIED');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ALL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('TO');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ORDER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ON');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('FLOAT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DATE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('HAVING');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('CLUSTER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('NOWAIT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('RESOURCE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ANY');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('TABLE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INDEX');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('FOR');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('UPDATE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('WHERE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('CHECK');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SMALLINT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('WITH');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DELETE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('BY');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ASC');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('REVOKE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('LIKE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SIZE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('RENAME');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('NOCOMPRESS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('NULL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('GROUP');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('VALUES');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('AS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('IN');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('VIEW');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('EXCLUSIVE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('COMPRESS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SYNONYM');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SELECT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INSERT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('EXISTS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('NOT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('TRIGGER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ELSE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('CREATE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INTERSECT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('PCTFREE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DISTINCT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('CONNECT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SET');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('MODE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('OF');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('UNIQUE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('VARCHAR2');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('VARCHAR');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('LOCK');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('OR');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('CHAR');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('DECIMAL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('UNION');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('PUBLIC');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('AND');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('START');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('USER');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('VALIDATE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('COMMENT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('UID');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ROWNUM');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('AUDIT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ACCESS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('FILE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('OFFLINE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SESSION');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('PRIVILEGES');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ADD');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('COLUMN');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('CURRENT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('IMMEDIATE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INCREMENT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('INITIAL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('MAXEXTENTS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('MLSLABEL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('MODIFY');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('NOAUDIT');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ONLINE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ROW');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ROWID');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('ROWS');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SUCCESSFUL');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('SYSDATE');
Insert into LANA.MIGRATION_RESERVED_WORDS (KEYWORD) values ('WHENEVER');
...
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_COLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_DATABASES
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_DATABASE_PRINCIPALS
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_DATABASE_ROLE_MEMBERS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_INDEXES
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_SERVER_PRINCIPALS
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_SQL_MODULES
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_SYSPROPERTIES
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_TABLES
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_TABLE_PRIVILEGES
SET DEFINE OFF;
REM INSERTING into LANA.SS2K5_TYPES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_MIGRLOG
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SERVERDETAIL
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_CHECK_CONSTRAINTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_COLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_DATABASES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_DB_PRINCIPALS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_IDENTITY_COLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_INDEXES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_INDEX_COLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_OBJECTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_SCHEMAS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_SCHEMATA
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_SERVER_PRINCIPALS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_SQL_MODULES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_SYSPROPERTIES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_TABLES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_TABLE_PRIVILEGES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SS2K5_TYPES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSCOLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSCOMMENTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSCONSTRAINTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSDATABASES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSINDEXES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSOBJECTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSREFERENCES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSTYPES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_SYB12_SYSUSERS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_ALL_RI_PARENTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_COLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_DATABASES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_FKEYS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_IDXCONSTRAINTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_INDICES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_JOININDICES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_LOG
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_CHECK
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_FKEYS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_INDC
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_INDDET
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_INDEXES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_PKEYS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_PROCS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_TABLES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_TRIGS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_VDEFNS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_OFFLINE_VIEWS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_PROCEDURES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_SHOWTBLCHECKS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_TABLES
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_TABLETEXT
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_TRIGGERS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TERADATA_UDTS
SET DEFINE OFF;
REM INSERTING into LANA.STAGE_TRANSLATEDSQL
SET DEFINE OFF;
REM INSERTING into LANA.SYB12_SYSCOLUMNS
SET DEFINE OFF;
REM INSERTING into LANA.SYB12_SYSCOMMENTS
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_IX_COLUMNS_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_INDEX_COLUMNS" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index SS2K5_TABLE_PRIVILEGES_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_TABLE_PRIVILEGES_DB_ID" ON "LANA"."SS2K5_TABLE_PRIVILEGES" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_SCHEMAS_DBID_GEN_FK
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_SCHEMAS_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_SCHEMAS" ("DBID_GEN_FK") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_PS_MAJOR_ID" ON "LANA"."STAGE_SS2K5_SYSPROPERTIES" ("MAJOR_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_COLUMNS_OBJ_IND
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_COLUMNS_OBJ_IND" ON "LANA"."STAGE_SS2K5_COLUMNS" ("SVRID_FK", "DBID_GEN_FK", "OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_C_C_OBJECT_ID" ON "LANA"."SS2K5_CHECK_CONSTRAINTS" ("OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "LANA"."MIGR_GENERATION_ORDER_PK" ON "LANA"."MIGR_GENERATION_ORDER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_ITY_CS_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_IDENTITY_COLUMNS" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index MD_TABLES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."MD_TABLES_PK" ON "LANA"."MD_TABLES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_T_P_TABLE_NAME" ON "LANA"."STAGE_SS2K5_TABLE_PRIVILEGES" ("TABLE_NAME") ;
--------------------------------------------------------
--  DDL for Index MD_USERS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."MD_USERS_PK" ON "LANA"."MD_USERS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "LANA"."MD_SCHEMAS_PK" ON "LANA"."MD_SCHEMAS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_DEFAULT_DB_ID" ON "LANA"."SS2K5_DEFAULT_CONSTRAINTS" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_D_R_M_MEMBER_P_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_D_R_M_MEMBER_P_ID" ON "LANA"."STAGE_SS2K5_DB_ROLE_MEMBERS" ("MEMBER_PRINCIPAL_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_SCHEMAS_NAME
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_SCHEMAS_NAME" ON "LANA"."STAGE_SS2K5_SCHEMAS" ("NAME") ;
--------------------------------------------------------
--  DDL for Index SS2K5_SERVER_PRINCIPALS_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_SERVER_PRINCIPALS_DB_ID" ON "LANA"."SS2K5_SERVER_PRINCIPALS" ("DB_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_DATABASES_DATABASE_ID" ON "LANA"."STAGE_SS2K5_DATABASES" ("DATABASE_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_S_P_SID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_S_P_SID" ON "LANA"."STAGE_SS2K5_SERVER_PRINCIPALS" ("SID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."MD_TABLES_PERF_IDX2" ON "LANA"."MD_VIEWS" (UPPER("VIEW_NAME"), "SCHEMA_ID_FK") 
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_D_P_DB_ID" ON "LANA"."SS2K5_DATABASE_PRINCIPALS" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_TYPES_USER_TYPE_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_TYPES_USER_TYPE_ID" ON "LANA"."STAGE_SS2K5_TYPES" ("USER_TYPE_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_DATABASES_NAME
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_DATABASES_NAME" ON "LANA"."STAGE_SS2K5_DATABASES" ("NAME") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_S_P_NAME
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_S_P_NAME" ON "LANA"."STAGE_SS2K5_SERVER_PRINCIPALS" ("NAME") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_D_R_M_ROLE_PL_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_D_R_M_ROLE_PL_ID" ON "LANA"."STAGE_SS2K5_DB_ROLE_MEMBERS" ("ROLE_PRINCIPAL_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_SQL_MS_OBJECT_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_SQL_MS_OBJECT_ID" ON "LANA"."STAGE_SS2K5_SQL_MODULES" ("OBJECT_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_F_K_C_PARENT_OBJECT_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_F_K_C_PARENT_OBJECT_ID" ON "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" ("PARENT_OBJECT_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_CHECK_CONSTRAINTS_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_CHECK_CONSTRAINTS_DB_ID" ON "LANA"."SS2K5_CHECK_CONSTRAINTS" ("DB_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_D_R_M_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_DB_ROLE_MEMBERS" ("DBID_GEN_FK") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_SCHEMATA_DB_ID" ON "LANA"."SS2K5_SCHEMATA" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_T_P_TABLE_SCHEMA
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_T_P_TABLE_SCHEMA" ON "LANA"."SS2K5_TABLE_PRIVILEGES" ("TABLE_SCHEMA") ;
--------------------------------------------------------
--  DDL for Index SS2K5_INDEXES_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_INDEXES_DB_ID" ON "LANA"."SS2K5_INDEXES" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index MD_REGISTRY_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."MD_REGISTRY_PK" ON "LANA"."MD_REGISTRY" ("OBJECT_TYPE", "OBJECT_NAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "LANA"."MD_TRIGGERS_PK" ON "LANA"."MD_TRIGGERS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_D_P_SID" ON "LANA"."SS2K5_DATABASE_PRINCIPALS" ("SID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_D_P_DT_SCHEMA_NAME
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_D_P_DT_SCHEMA_NAME" ON "LANA"."STAGE_SS2K5_DB_PRINCIPALS" ("DEFAULT_SCHEMA_NAME") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "LANA"."MD_USER_DEFINED_DATA_TYPES_PK" ON "LANA"."MD_USER_DEFINED_DATA_TYPES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_I_C_OBJECT_ID" ON "LANA"."SS2K5_IDENTITY_COLUMNS" ("OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_SCHEMATA_SCHEMA_NAME" ON "LANA"."SS2K5_SCHEMATA" ("SCHEMA_NAME") ;
--------------------------------------------------------
--  DDL for Index SS2K5_IDENTITY_COLUMNS_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_IDENTITY_COLUMNS_DB_ID" ON "LANA"."SS2K5_IDENTITY_COLUMNS" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_TYPES_SYSTEM_TYPE_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_TYPES_SYSTEM_TYPE_ID" ON "LANA"."SS2K5_TYPES" ("SYSTEM_TYPE_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_TABLES_DB_ID" ON "LANA"."SS2K5_TABLES" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index STAGE_MIGRLOG_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."STAGE_MIGRLOG_PK" ON "LANA"."STAGE_MIGRLOG" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_COLUMNS_OBJID" ON "LANA"."SS2K5_COLUMNS" ("OBJECT_ID", "COLUMN_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_SERVER_PRINCIPALS_SID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_SERVER_PRINCIPALS_SID" ON "LANA"."SS2K5_SERVER_PRINCIPALS" ("SID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_F_K_C_PARENT_OT_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_F_K_C_PARENT_OT_ID" ON "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" ("PARENT_OBJECT_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_DEFAULT_OBJECT_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_DEFAULT_OBJECT_ID" ON "LANA"."STAGE_SS2K5_DT_CONSTRAINTS" ("OBJECT_ID") ;
--------------------------------------------------------
--  DDL for Index MIGRLOG_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."MIGRLOG_PK" ON "LANA"."MIGRLOG" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_F_K_C_DB_ID" ON "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_F_K_C_R_O_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_F_K_C_R_O_ID" ON "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" ("REFERENCED_OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_IX_COLUMNS_OBJECT_ID" ON "LANA"."STAGE_SS2K5_INDEX_COLUMNS" ("OBJECT_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_SQL_MODULES_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_SQL_MODULES_DB_ID" ON "LANA"."SS2K5_SQL_MODULES" ("DB_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."MIGRLOG_PERF_IDX" ON "LANA"."MIGRLOG" ("REF_OBJECT_ID", "SEVERITY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_C_C_OBJECT_ID" ON "LANA"."STAGE_SS2K5_CHECK_CONSTRAINTS" ("OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_DATABASES_DATABASE_ID" ON "LANA"."SS2K5_DATABASES" ("DATABASE_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_I_C_OBJECT_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_I_C_OBJECT_ID" ON "LANA"."STAGE_SS2K5_IDENTITY_COLUMNS" ("OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_TABLES_OBJECT_ID" ON "LANA"."SS2K5_TABLES" ("OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_COLUMNS_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_COLUMNS" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index MD_VIEWS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."MD_VIEWS_PK" ON "LANA"."MD_VIEWS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_S_P_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_SERVER_PRINCIPALS" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index SS2K5_COLUMNS_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_COLUMNS_DB_ID" ON "LANA"."SS2K5_COLUMNS" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_F_K_C_DBID_GEN_FK
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_F_K_C_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_COLUMNS_COLUMN_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_COLUMNS_COLUMN_ID" ON "LANA"."STAGE_SS2K5_COLUMNS" ("COLUMN_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_SERVER_PRINCIPALS_NAME
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_SERVER_PRINCIPALS_NAME" ON "LANA"."SS2K5_SERVER_PRINCIPALS" ("NAME") ;
--------------------------------------------------------
--  DDL for Index SS2K5_SQL_MODULES_OBJECT_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_SQL_MODULES_OBJECT_ID" ON "LANA"."SS2K5_SQL_MODULES" ("OBJECT_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_D_R_M_DB_ID" ON "LANA"."SS2K5_DATABASE_ROLE_MEMBERS" ("DB_ID") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_TYPES_DBID_GEN_FK
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_TYPES_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_TYPES" ("DBID_GEN_FK") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_DATABASES_NAME" ON "LANA"."SS2K5_DATABASES" ("NAME") ;
--------------------------------------------------------
--  DDL for Index SS2K5_OBJECTS_DB_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_OBJECTS_DB_ID" ON "LANA"."SS2K5_OBJECTS" ("DB_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_TE_PS_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_TABLE_PRIVILEGES" ("DBID_GEN_FK") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_D_P_DEFAULT_SCHEMA_NAME" ON "LANA"."SS2K5_DATABASE_PRINCIPALS" ("DEFAULT_SCHEMA_NAME") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_INDEX_COLUMNS_OBJECT_ID" ON "LANA"."SS2K5_INDEX_COLUMNS" ("OBJECT_ID") ;
--------------------------------------------------------
--  DDL for Index SS2K5_D_R_M_MEMBER_P_ID
--------------------------------------------------------

  CREATE INDEX "LANA"."SS2K5_D_R_M_MEMBER_P_ID" ON "LANA"."SS2K5_DATABASE_ROLE_MEMBERS" ("MEMBER_PRINCIPAL_ID") ;
--------------------------------------------------------
--  DDL for Index MD_SYNONYMS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "LANA"."MD_SYNONYMS_PK" ON "LANA"."MD_SYNONYMS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_CK_CTS_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_CHECK_CONSTRAINTS" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index S_SS2K5_TABLES_DBID_GEN_FK
--------------------------------------------------------

  CREATE INDEX "LANA"."S_SS2K5_TABLES_DBID_GEN_FK" ON "LANA"."STAGE_SS2K5_TABLES" ("DBID_GEN_FK") ;
--------------------------------------------------------
--  DDL for Index MD_TABLES_PERF_IDX1
--------------------------------------------------------

  CREATE INDEX "LANA"."MD_TABLES_PERF_IDX1" ON "LANA"."MD_TABLES" (UPPER("TABLE_NAME"), "SCHEMA_ID_FK") 
  PCTFREE 10 INITRANS 2 MAXTRANS 166 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."S_SS2K5_SCHEMATA_SCHEMA_NAME" ON "LANA"."STAGE_SS2K5_SCHEMATA" ("SCHEMA_NAME") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "LANA"."SS2K5_TYPES_USER_TYPE_ID" ON "LANA"."SS2K5_TYPES" ("USER_TYPE_ID") ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."DEL_MD_TRIGGERS_T_TRG" AFTER DELETE ON MD_TABLES 
FOR EACH ROW 
BEGIN
...
/
ALTER TRIGGER "LANA"."DEL_MD_TRIGGERS_T_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger DEL_MD_TRIGGERS_V_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."DEL_MD_TRIGGERS_V_TRG" AFTER DELETE ON MD_VIEWS
FOR EACH ROW 
BEGIN
...
/
ALTER TRIGGER "LANA"."DEL_MD_TRIGGERS_V_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENCOLUMNKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENCOLUMNKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."GENCOLUMNKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENCONNKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENCONNKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."GENCONNKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENDBKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENDBKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."GENDBKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENINDEXKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENINDEXKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."GENINDEXKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENOBJECTKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENOBJECTKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."GENOBJECTKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSCHEMAKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSCHEMAKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."GENSCHEMAKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5CHKCONSTTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5CHKCONSTTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5CHKCONSTTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5COLUMNKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5COLUMNKEYTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5COLUMNKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5DATABASEPRINCIPALTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5DATABASEPRINCIPALTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5DATABASEPRINCIPALTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5DB2KEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5DB2KEYTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5DB2KEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5DEFCONSTTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5DEFCONSTTRIG" BEFORE
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5IDENTCOLRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5IDENTCOLRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5INDEXTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5INDEXTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5INDEXTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5OBJECTKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5OBJECTKEYTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5OBJECTKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5SCHEMAKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5SCHEMAKEYTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5SCHEMAKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5SCHEMATAKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5SCHEMATAKEYTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5SCHEMATAKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5SQLMODTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5SQLMODTRIG" BEFORE
...
/
ALTER TRIGGER "LANA"."GENSS2K5SQLMODTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger GENSS2K5SQLTABTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."GENSS2K5SQLTABTRIG" BEFORE
  INSERT ON STAGE_SS2K5_SQL_MODULES FOR EACH ROW BEGIN IF :new.OBJID_GEN IS NULL THEN :new.OBJID_GEN := MD_META.get_next_id;
END IF;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_SCHEMAS_TRG" BEFORE INSERT OR UPDATE ON MD_SCHEMAS
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_SCHEMAS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MD_SEQUENCES_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_SEQUENCES_TRG" BEFORE INSERT OR UPDATE ON MD_SEQUENCES
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_SYNONYMS_TRG" BEFORE INSERT OR UPDATE ON MD_SYNONYMS
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_TABLES_TRG" BEFORE INSERT OR UPDATE ON MD_TABLES
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_TABLES_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MD_TRIGGERS_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_TRIGGERS_TRG" BEFORE INSERT OR UPDATE ON MD_TRIGGERS
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_TRIGGERS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MD_USERS_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_USERS_TRG" BEFORE INSERT OR UPDATE ON MD_USERS
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_USERS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MD_USER_DEFINED_DATA_TYPES_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_USER_DEFINED_DATA_TYPES_TRG" BEFORE INSERT OR UPDATE ON MD_USER_DEFINED_DATA_TYPES
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_USER_DEFINED_DATA_TYPES_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MD_USER_PRIVILEGES_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_USER_PRIVILEGES_TRG" BEFORE INSERT OR UPDATE ON MD_USER_PRIVILEGES
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_USER_PRIVILEGES_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MD_VIEWS_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MD_VIEWS_TRG" BEFORE INSERT OR UPDATE ON MD_VIEWS
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MD_VIEWS_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MIGRLOG_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MIGRLOG_TRG" BEFORE INSERT OR UPDATE ON MIGRLOG
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MIGR_DATATYPE_RULE_TRG" BEFORE INSERT OR UPDATE ON MIGR_DATATYPE_TRANSFORM_RULE
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MIGR_DATATYPE_RULE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MIGR_GENERATION_ORDER_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."MIGR_GENERATION_ORDER_TRG" BEFORE INSERT OR UPDATE ON MIGR_GENERATION_ORDER
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."MIGR_GENERATION_ORDER_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger STAGE_MIGRLOG_ID_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."STAGE_MIGRLOG_ID_TRG" BEFORE INSERT OR UPDATE ON STAGE_MIGRLOG
FOR EACH ROW
BEGIN
  if inserting and :new.id is null then
        :new.id := MD_META.get_next_id;
...
/
ALTER TRIGGER "LANA"."STAGE_MIGRLOG_ID_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger STAGE_MIGRLOG_LOG_DATE_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."STAGE_MIGRLOG_LOG_DATE_TRG" BEFORE INSERT OR UPDATE ON STAGE_MIGRLOG
FOR EACH ROW
BEGIN
...
/
ALTER TRIGGER "LANA"."STAGE_MIGRLOG_LOG_DATE_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENCHECKTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENCHECKTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENCHECKTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENCOLUMNKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENCOLUMNKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENCOLUMNKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENCONNKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENCONNKEYTRIG" 
                    BEFORE INSERT ON STAGE_SERVERDETAIL 
                    FOR EACH ROW 
                    BEGIN
                      IF :new.project_id IS NULL THEN
...
/
ALTER TRIGGER "LANA"."TDATA_GENCONNKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENFKEYKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENFKEYKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENFKEYKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENIDXCONSTKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENIDXCONSTKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENIDXCONSTKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENINDICESKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENINDICESKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENINDICESKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENPROCSTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENPROCSTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENPROCSTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENSCHEMAKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENSCHEMAKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENSCHEMAKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENTABLEKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENTABLEKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENTABLEKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENTRIGGERKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENTRIGGERKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENTRIGGERKEYTRIG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TDATA_GENUDTKEYTRIG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LANA"."TDATA_GENUDTKEYTRIG" 
...
/
ALTER TRIGGER "LANA"."TDATA_GENUDTKEYTRIG" ENABLE;
--------------------------------------------------------
...
/*inserta una nueva venta*/
 (nimfisp IN NUMBER, idalmacenp IN NUMBER) AS
 ...
 BEGIN
    ...
    INSERT INTO VENTA(NUMVENTA, NUMFISCAL, IDALMACEN) VALUES(lastVentaId + 1, nimfisp, idalmacenp);
 END insertVenta;
...
cuyo NIF constituye el segundo parámetro del procedimiento.*/
 ...
 (amountp IN NUMBER, numestp IN NUMBER) AS
    ...
    CURSOR ventas_menores IS
        ...
        ON alm.IDALMACEN = ven.IDALMACEN
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."MD_META" 
AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."MIGRATION" 
AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."MIGRATION_REPORT" AS 
--get status
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."MIGRATION_TRANSFORMER" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."SS2K5ALLPLATFORM" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."SYB12ALLPLATFORM" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "LANA"."TDALLPLATFORM" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."MD_META" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."MIGRATION" AS
/**
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."MIGRATION_REPORT" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."MIGRATION_TRANSFORMER" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."SS2K5ALLPLATFORM" 
AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."SYB12ALLPLATFORM" AS   
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "LANA"."TDALLPLATFORM" AS   
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."SS2K5_DATABASES" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_MIGRLOG
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_MIGRLOG" ADD CONSTRAINT "STAGE_MIGRLOG_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."STAGE_MIGRLOG" MODIFY ("SEVERITY" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_MIGRLOG" MODIFY ("LOG_DATE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_MIGRLOG" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SS2K5_OBJECTS" MODIFY ("IS_MS_SHIPPED" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_OBJECTS" MODIFY ("PARENT_OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_OBJECTS" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_OBJECTS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_OBJECTS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_OBJECTS" MODIFY ("SCHEMA_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_INDEX_COLUMNS
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_INDEX_COLUMNS" MODIFY ("COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_INDEX_COLUMNS" MODIFY ("INDEX_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_INDEX_COLUMNS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_INDEX_COLUMNS" MODIFY ("INDEX_COLUMN_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_TABLES
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_TABLES" ADD CONSTRAINT "MD_TABLES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_TABLES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TABLES" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TABLES" MODIFY ("QUALIFIED_NATIVE_NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TABLES" MODIFY ("TABLE_NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SS2K5_COLUMNS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_COLUMNS" MODIFY ("DEFAULT_OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_COLUMNS" MODIFY ("SYSTEM_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_COLUMNS" MODIFY ("USER_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_COLUMNS" MODIFY ("SCALE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_COLUMNS" MODIFY ("PRECISION" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SS2K5_DT_CONSTRAINTS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SYB12_SYSUSERS
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SYB12_SYSUSERS" MODIFY ("DB_UID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_DB_PRINCIPALS
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_DB_PRINCIPALS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_DB_PRINCIPALS" MODIFY ("PRINCIPAL_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_DB_PRINCIPALS" MODIFY ("TYPE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_DEFAULT_CONSTRAINTS
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_DEFAULT_CONSTRAINTS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_INDEXES
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_INDEXES" MODIFY ("INDEX_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_INDEXES" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_SEQUENCES
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_SEQUENCES" ADD CONSTRAINT "MD_SEQUENCES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("CREATED_BY" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("INCR" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("SEQ_START" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("SCHEMA_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SEQUENCES" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SYB12_SYSINDEXES
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SYB12_SYSINDEXES" MODIFY ("INDEX_NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_REGISTRY
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_REGISTRY" ADD CONSTRAINT "MD_REGISTRY_PK" PRIMARY KEY ("OBJECT_TYPE", "OBJECT_NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" ADD CONSTRAINT "MD_USER_DEFINED_DATA_TYPES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("NATIVE_SQL" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("DEFINITION" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("DATA_TYPE_NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("SCHEMA_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_SCHEMAS
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_SCHEMAS" ADD CONSTRAINT "MD_SCHEMAS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_SCHEMAS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SCHEMAS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SCHEMAS" MODIFY ("CATALOG_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SCHEMAS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_SCHEMATA
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_SCHEMATA" MODIFY ("SCHEMA_NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SCHEMATA" MODIFY ("SCHEMA_OWNER" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_USER_PRIVILEGES" ADD CONSTRAINT "MD_USER_PRIVILEGES_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_USER_PRIVILEGES" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USER_PRIVILEGES" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_VIEWS" ADD CONSTRAINT "MD_VIEWS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_VIEWS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_VIEWS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_VIEWS" MODIFY ("LANGUAGE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."SS2K5_TABLE_PRIVILEGES" MODIFY ("TABLE_NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_TARGET_ALL_ERRORS
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_TARGET_ALL_ERRORS" MODIFY ("TEXT" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TARGET_ALL_ERRORS" MODIFY ("POSITION" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TARGET_ALL_ERRORS" MODIFY ("LINE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TARGET_ALL_ERRORS" MODIFY ("SEQUENCE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TARGET_ALL_ERRORS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TARGET_ALL_ERRORS" MODIFY ("OWNER" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SS2K5_INDEX_COLUMNS" MODIFY ("COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_INDEX_COLUMNS" MODIFY ("INDEX_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_INDEX_COLUMNS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_INDEX_COLUMNS" MODIFY ("INDEX_COLUMN_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SYB12_SYSOBJECTS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MD_TRIGGERS
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_TRIGGERS" ADD CONSTRAINT "MD_TRIGGERS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_TRIGGERS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TRIGGERS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TRIGGERS" MODIFY ("LANGUAGE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_TRIGGERS" MODIFY ("TRIGGER_ON_FLAG" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_USERS" ADD CONSTRAINT "MD_USERS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_USERS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_USERS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SS2K5_SYSPROPERTIES" MODIFY ("VALUE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SYSPROPERTIES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SYSPROPERTIES" MODIFY ("MINOR_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SYSPROPERTIES" MODIFY ("MAJOR_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SYSPROPERTIES" MODIFY ("CLASS" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_INDEXES
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_INDEXES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_INDEXES" MODIFY ("INDEX_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_INDEXES" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_CHECK_CONSTRAINTS
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_CHECK_CONSTRAINTS" MODIFY ("PARENT_COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_CHECK_CONSTRAINTS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."STAGE_SS2K5_SCHEMAS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SCHEMAS" MODIFY ("SCHEMA_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_SERVER_PRINCIPALS
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_SERVER_PRINCIPALS" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_SERVER_PRINCIPALS" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_SYSPROPERTIES
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_SYSPROPERTIES" MODIFY ("VALUE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_SYSPROPERTIES" MODIFY ("NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" ADD CONSTRAINT "MIGR_DATATYPE_TRANSFORM_R_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" MODIFY ("TARGET_DATA_TYPE_NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" MODIFY ("SOURCE_DATA_TYPE_NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" MODIFY ("MAP_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_DATATYPE_TRANSFORM_RULE" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_SYNONYMS" ADD CONSTRAINT "MD_SYNONYMS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("CREATED_ON" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("SECURITY_GROUP_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("FOR_OBJECT_TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("SYNONYM_FOR_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("SCHEMA_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MD_SYNONYMS" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_TABLES
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_TABLES" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_TABLES" MODIFY ("SCHEMA_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_TABLES" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_TABLES" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table MIGR_GENERATION_ORDER
--------------------------------------------------------

  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" ADD CONSTRAINT "MIGR_GENERATION_ORDER_UK" UNIQUE ("OBJECT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" ADD CONSTRAINT "MIGR_GENERATION_ORDER_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" MODIFY ("GENERATION_ORDER" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" MODIFY ("OBJECT_TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" MODIFY ("CONNECTION_ID_FK" NOT NULL ENABLE);
  ALTER TABLE "LANA"."MIGR_GENERATION_ORDER" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_SQL_MODULES
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_SQL_MODULES" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_TYPES
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_TYPES" MODIFY ("SYSTEM_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_TYPES" MODIFY ("USER_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_TYPES" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_OBJECTS
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_OBJECTS" MODIFY ("IS_MS_SHIPPED" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_OBJECTS" MODIFY ("PARENT_OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_OBJECTS" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_OBJECTS" MODIFY ("NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."SS2K5_SERVER_PRINCIPALS" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_SERVER_PRINCIPALS" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_COLUMNS
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("DEFAULT_OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("SYSTEM_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("USER_TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("SCALE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("PRECISION" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("MAX_LENGTH" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_COLUMNS" MODIFY ("RULE_OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SS2K5_FOREIGN_KEY_COLUMNS
--------------------------------------------------------

  ALTER TABLE "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" MODIFY ("REFERENCED_OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" MODIFY ("REFERENCED_COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" MODIFY ("PARENT_COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_FOREIGN_KEY_COLUMNS" MODIFY ("PARENT_OBJECT_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."SS2K5_TABLES" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_TABLES" MODIFY ("SCHEMA_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_TABLES" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_TABLES" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_TYPES
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_TYPES" MODIFY ("SYSTEM_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MIGRLOG" ADD CONSTRAINT "MIGRLOG_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "LANA"."MIGRLOG" MODIFY ("SEVERITY" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."SS2K5_IDENTITY_COLUMNS" MODIFY ("COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."SS2K5_IDENTITY_COLUMNS" MODIFY ("OBJECT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table STAGE_SS2K5_FN_KEY_COLUMNS
--------------------------------------------------------

  ALTER TABLE "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" MODIFY ("REFERENCED_OBJECT_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" MODIFY ("REFERENCED_COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" MODIFY ("PARENT_COLUMN_ID" NOT NULL ENABLE);
  ALTER TABLE "LANA"."STAGE_SS2K5_FN_KEY_COLUMNS" MODIFY ("PARENT_OBJECT_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_SYNONYMS" ADD CONSTRAINT "MD_SYNONYMS_MD_SCHEMAS_FK1" FOREIGN KEY ("SCHEMA_ID_FK")
	  REFERENCES "LANA"."MD_SCHEMAS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_USERS" ADD CONSTRAINT "MD_USERS_MD_SCHEMAS_FK1" FOREIGN KEY ("SCHEMA_ID_FK")
	  REFERENCES "LANA"."MD_SCHEMAS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MD_USER_DEFINED_DATA_TYPES
--------------------------------------------------------

  ALTER TABLE "LANA"."MD_USER_DEFINED_DATA_TYPES" ADD CONSTRAINT "MD_USER_DEFINED_DATA_TYPE_FK1" FOREIGN KEY ("SCHEMA_ID_FK")
	  REFERENCES "LANA"."MD_SCHEMAS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LANA"."MD_VIEWS" ADD CONSTRAINT "MD_VIEWS_MD_SCHEMAS_FK1" FOREIGN KEY ("SCHEMA_ID_FK")
	  REFERENCES "LANA"."MD_SCHEMAS" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
